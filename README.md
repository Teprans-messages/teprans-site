...
- **Голосовые сообщения:** Оптимизированный singleton аудио-плеер, плавный прогресс и скорость x1.5 / x2.
- **Реакции на сообщения (Emoji Reactions):** Всплывающая панель реакций (👍, ❤️, 🔥, 😂, 😮, 😢, 🎉, 👏) с подсчетом голосов.
- **Встроенный AI переводчик:** Мгновенный перевод сообщений на русский/английский прямо в чате в 1 клик.
- **Ответы (Reply):** Свайпните любое сообщение вправо с тактильным откликом для быстрого цитирования.
- **Статусы отправки и прочтения:** Часики 🕒 при отправке, одна галочка ✓ при доставке и две синие галочки ✓✓ при прочтении.
- **Полноэкранный просмотр медиа:** Просмотр фото и картинок на весь экран с плавным двойным тапом для зума.
- **Управление кэшем и памятью:** Анализ занимаемого места и мгновенная очистка кэша в Настройках.
